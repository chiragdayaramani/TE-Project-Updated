...
INSERT INTO `users_after12science` (`id`, `question`) VALUES (NULL, 'Teach an individual an exercise routine'), (NULL, 'Assemble electronic parts'), (NULL, 'Compute and record statistical and other numerical data'), (NULL, 'Load computer software into a large computer network'), (NULL, 'Provide physical therapy to people recovering from an injury'), (NULL, 'Perform nursing duties in a hospital'), (NULL, 'Sell computer equipment in a store'), (NULL, 'Develop a way to better predict the weather'), (NULL, 'Test the quality of parts before shipment'), (NULL, 'Teach sign language to people with hearing disabilities')

INSERT INTO `users_after12commerce` (`id`, `question`) VALUES (NULL, 'Assemble Products in a Factory'), (NULL, 'Study ways to reduce water pollution'), (NULL, 'Help people with personal or emotional problems'), (NULL, 'Handle customers’ bank transactions'), (NULL, 'Repair household appliances'), (NULL, 'Buy and sell land'), (NULL, 'Manage a supermarket'), (NULL, 'Draw pictures'), (NULL, 'Manage a department within a large company'), (NULL, 'Manage the operations of a hotel')
